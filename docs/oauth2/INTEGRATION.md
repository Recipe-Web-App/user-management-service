...
This guide provides comprehensive instructions for integrating the User Management Service with an external OAuth2 authentication service.

## Overview

The User Management Service supports **dual authentication modes** to provide flexibility during migration and different use cases:
...
2. **OAuth2 service redirects with authorization code:**
```http
HTTP/1.1 302 Found
...
4. **OAuth2 service returns tokens:**
```json
{
...
For development, you can use a mock OAuth2 service or configure the service to use JWT validation mode with a development OAuth2 service.
...
This guide should provide everything needed to integrate the User Management Service with your OAuth2 authentication service. For additional support, refer to the API documentation and development guide.